...
<header>
    <div class='container py-3'>
        ...
        <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
            ...
            <a class="me-3 py-2 text-dark text-decoration-none" href="{{ route('student.create') }}">Ajouter un(e) étudiant(e)</a>
        </nav>
    </div>
</header>
<body>
...
<footer class="py-3 my-4">
    <div class='container py-3'>
        <ul class="nav justify-content-center border-bottom pb-3 mb-3">
            ...
            <li class="nav-item"><a href="{{ route('student.create') }}" class="nav-link px-2 text-muted">Ajouter un(e) étudiant(e)</a></li>
        </ul>
